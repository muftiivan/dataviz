...
plot_household <- 
  plot_household +
  labs(
    title = "The World Bank tahun 2019",
    subtitle = " grafik plot_household.",
    caption = "Author: Mufti Ivan Agusta \n Contact: mufti.agusta@gmail.com \n Data source: The World Bank, 2019",
    x = "electricity_total",
    y = "safe_sanitation",
    colour = " year",
    size = "safe_water"
...
terjadi pada grafik tersebut? \#bisa pake facet\_grid
